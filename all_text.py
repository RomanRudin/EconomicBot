...
Я же в свою очередь вычислаю Qd и Qs при заданном уровне цены E,
...
C = Q*Vc + Fc, где Vc - сумма переменных издержек; Fc - сумма постоянных ихдержек;
...
def create_solution_def_surp_text(A: float, B: float, C: float, D: float, E: float,
    ...
    support_comparison_text = "Qd = Qs" if condition == "равновесия" else f"""
Qd {'>' if condition == "дефицита" else '<'} Qs
